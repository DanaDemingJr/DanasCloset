...
namespace DanasCloset.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopsID,Name,Photo,Type,Color,Season,Occasion")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopsID,Name,Photo,Type,Color,Season,Occasion")] Top top)
        {
            if (ModelState.IsValid)
            {
